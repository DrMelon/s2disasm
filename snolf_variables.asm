...
SNOLF_Force_Allow: ds.b 2		; 1 byte - force allow swings. for autoscroll sections or other difficult areas.
SNOLF_Force_Next: ds.b 2		; 1 byte - same as snolf force allow, but only for 1 swing - good for strange obstacles like waterslides